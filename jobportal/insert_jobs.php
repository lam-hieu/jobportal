	...
	<form name="insert_jobs_info" method="POST">
		<div id="bannr-lft" align='center'><br /><br /><br /><br /><br /><br /><br />
			...
			<table align=center>
				<!-- SKILLS-->
				<tr>
					<td colspan="4"><input type="text" Placeholder="Type Your Skills, Designation etc." value="" name="skills" size="40"></td>
				</tr>
				<!-- SKILL CLOSE-->
				<!-- CITY -->
				<tr>
					<td colspan="4"><input type="text" placeholder="Type City Where You Want To Work" value="" name="city" size="40"></td>
				</tr>
				<!-- CITY CLOSE -->
				<tr>
					<td>Job Category </td>
					<td>Experience</td>
					<td colspan="2">Salary Expectation</td>
				</tr>
				<tr>
					<td>
						<!-- JOB_CATEGORY-->
				...
				<tr>
					<td colspan="4"><input type="submit" value="Insert" name="b1" /></td>
				</tr>
