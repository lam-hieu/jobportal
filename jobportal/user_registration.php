...
<body style=" background-color:#FFFFFF;">
	...
	<div style="width:100%; height:auto; border:solid 0px #990000;">
		...
		<div style="width:1050px;  height:auto; margin:auto; border:solid 0px #00FF00;">
			<!--header-->
			<div style="width:1048px; height:120px; border:solid 0px #CCCCCC;">
						...
						<div style="width:810px; height:auto; float:left; margin:auto;">
							...
							<form name="carform" action="u_dbc.php" method="post" enctype="multipart/form-data" onsubmit="return validation()">
								...
								<table width="500" height="106" border="0" align="center" bordercolor="#000000">
									...
									<tr>
										<th width="337" height="20" scope="row">
											<div align="right">
										...
										<td width="501" height="20">
											<div align="left">
												...
												<input name="full_name" type="text" maxlength="15" size="30" value="" />
												<!--dfgdfgdfg-->
											</div>
										</td>
									</tr>
									<tr>
										<td height="50" scope="row">
											<div align="right">
												<font color='red'>*</font><b>Location :</b>
											</div>
										</td>
										<td width="501" height="20">
											<div align="left">
												<label>
													<input name="curr_loc" type="text" maxlength="15" size="30" value="" />
													<!--dfgdfgdfg-->
									...
									<tr>
										...
										<td width="501" height="20">
											<div align="left">
												...
												<input type="text" name="mob_no" size="30" value="" />
												<!--dfgdfgdfg-->
								...
								<table width='500' height='60' align="center" border="0" bordercolor="#000000">
									...
									<tr>
										<td width="337" height="20" scope="row">
											<div align="right"> <b>
									...
									<tr height="30">
										<th height="20" scope="row">
											<div align="right">
												<font color='red'>*</font>Create a password :
											</div>
										</th>
										<td width="501" height="20">
											<div align="left">
												<input type="password" name="crpass" size="30" id="crpass" />
												<!--dfgdfgdfg-->
											</div>
										</td>
									</tr>
									<tr height="30">
										...
										<td width="501" height="20">
											<div align="left">
												...
												<input type="password" name="conpass" id="conpass" size="30" />
												<!--dfgdfgdfg-->
								...
								<table width="500" height="126" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000" summary="rcmsandbjas">
									...
									<tr>
										<th width="337" height="20" scope="row">
											<div align="right">Experience : </div>
										</th>
										<td width="501" height="20">
											<div align="left">
									...
									<tr>
										...
										<td width="501" height="20">
											<div align="left">
												<input name="key_skill" type="text" maxlength="15" size="30" value="" />
												<!--dfgdfgdfg-->
			...
			<table width="500" height="96" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000" summary="rcmsandbjas">
				...
				<tr>
					<th width="450" height="40" scope="row">
						<div align="right">
							<div align="right">Upload Resume: </div>
							<span style="float:left; color: #999999; font-style:italic;"> </span>
					</th>
				...
				<tr>
					<td>
						<font color='red'><?php $r = $_GET['r'];
											if ($r == 1) echo "Invalid File"; ?></font>
					<td>
				</tr>
  ...
  <tr>
    ...
    <table><tr><td >
			...
			<tr>
				<td colspan='2' height="30" align="center"><input type="submit" value="submit" name="submit"></td>
			</tr>
			</tr>
			</table>
			<!--CLOSE FOURTH TABLE-->
