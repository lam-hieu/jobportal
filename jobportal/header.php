<div style="width:1048px; height:123px; background-color:#fff;border:solid 0px #F0F0F0;">
    ...
    <div style=" width:1048px; height:70px; border:#339933 0px solid;">
        <!--logo-->
        <div style="width:740px; height:68px; float:left; border:solid 0px #FF0000; padding-top:2%;"><a href="index.php" style="text-decoration:none; font-size:22px;">PHPGURUKUL Job Portal</a></div>
