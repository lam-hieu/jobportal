	...
	<div style="width:100%; height:auto; border:solid 0px #990000;">
		...
		<div style="width:1050px;  height:auto; margin:auto; border:solid 0px #00FF00;">
			...
			<div style="width:1048px; height:120px; background-color:#FFFFFF; border:solid 1px #CCCCCC;">
				<?php include('myaccountheader.php'); ?></div>
			<!--header close-->
								...
								<tr>
									<td>
										<div style="height:40px;background-color:#0C70A4;border:1px #ffffff solid;float:center;border-radius:5px;margin-left:2px;margin-right:2px;margin-top:2px;margin-bottom:0px;">
											<div style="margin-top:8px;margin-bottom:10px;margin-left:10px;color:#FFFFFF">
												<font size='5'><b>My Order</b></font>
											</div>
										</div>
									</td>
								</tr>
												...
												<?php if ($count > 0) {
													foreach ($cart as $c) {   ?>
														<tr height="25" style="color:#000000; text-align:center; font-family:Arial, Helvetica, sans-serif; font-size:14px;">
															...
															<td width="10%" style="background-color:#E0E0E0;"><?php echo "$c[1]";
																												$_SESSION['ORDER_ID'] = $c[1];  ?></td>
