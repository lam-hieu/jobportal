<div style="width:1048px; height:120px; background-color:#FFFFFF;border:solid 0px #FF0000;">
    ...
    <div style=" width:1048px; height:80px; border:#339933 0px solid;">
        ...
        <!--logo-->
        <div style="width:280px; height:78px; float:left; border:solid 0px #FF0000; padding-top:2%"><a href="index.php" style="text-decoration:none; font-size:22px;">PHPGURUKUL Job Portal</a></div>
